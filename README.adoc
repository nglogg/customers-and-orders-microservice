= An E-commerce Micro-Services Example project
...
Sagas are a mechanism for maintaining data consistency in a microservice architecture.
...
CQRS pattern implements queries that retrieves data from multiple services.
